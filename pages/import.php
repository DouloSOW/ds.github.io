...
?>
    ...
    <script type="text/javascript">
		var url1="TRAITEMENT_PHP/graph6.php"
		var url2="TRAITEMENT_PHP/graph13.php"
...
<img class="affiche" src="Images/import.jpg">

<p class="noms">Tableau de bord des cas importés <i class="fas fa-plane-arrival"></i></p>
			
	<form id="formulaire_sup" name="formulaire" enctype="multipart/form-data" method="post" action="" >
		
		<fieldset>
		<legend> Cas importés <i class="fas fa-plane-arrival"></i></legend>
					<br />
					<div id="resultat" name="imge">
																							<div id="container6" style="width:100%; height:400px;"> </div><br />
...
<form id="formulaire_sup" name="formulaire" enctype="multipart/form-data" method="post" action="" >
		...
		<fieldset>
		<legend> Evolution <i class="fas fa-plane-arrival"></i> </legend>
					<br />
					<div id="resultat" name="imge">	
					<div id="container13" style="width:100%; height:400px;"> </div><br />
						<strong>Note</strong> : Vous pouvez cliquer n'importe où sur le graphique et tirer pour zoomer. Les points de données individuels peuvent aussi être selectionnés pour afficher plus d'informations. Cliquer sur le bouton d'en haut à droite pour télécharger le graphique.
					</div>	
