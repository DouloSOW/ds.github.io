...
?>
    <script type="text/javascript">
		var url1="TRAITEMENT_PHP/graph5.php"
		var url2="TRAITEMENT_PHP/graph11.php"
...
<p class="noms">Tableau de bord des cas positifs<i class="fas fa-user-md"></i></p>
<div class="part1">		
	<form id="formulaire_sup" name="formulaire" enctype="multipart/form-data" method="post" action="" >

	
		<fieldset>
		<legend> Cas positifs <i class="fas fa-user-md"></i></legend>
					<br />
					<div id="resultat" name="imge">
						<div id="container5" style="width:100%; height:400px;"> </div><br />
	...
	<form id="formulaire_sup" name="formulaire" enctype="multipart/form-data" method="post" action="" >
		<fieldset>
		<legend> Evolution <i class="fas fa-user-md"></i></legend>
		<div id="resultat" name="imge">
	
					<div id="container11" style="width:100%; height:400px;"> </div><br />
						<strong>Note</strong> : Vous pouvez cliquer n'importe où sur le graphique et tirer pour zoomer. Les points de données individuels peuvent aussi être selectionnés pour afficher plus d'informations. Cliquer sur le bouton d'en haut à droite pour télécharger le graphique.
		</div>	
		</fieldset>
</form>
