...
$chaine.="
        var myChart = Highcharts.chart('container12', {
            chart: {
                type: 'line', 
				zoomType: 'x' 
            },
            title: {
                text: 'Evolution du nombre total de cas contacts'
            },
            xAxis: {
                categories: [  ";
...
$chaine.="  },yAxis: {
            ...
            series: [{
				name: 'Nombre total de cas contacts',
                data: [";
...
while($row=$resultat-> fetch_assoc())
{
    $ydata1[$i]=intval($row["cumul_cas_contact"]);
	$chaine.=$ydata1[$i].",";
	$i++;
}
$chaine.="],color: '#FF0000'
