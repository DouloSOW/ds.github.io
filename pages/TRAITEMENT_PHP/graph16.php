...
$chaine.="
        var myChart = Highcharts.chart('container16', {
            chart: {
                type: 'line', 
				zoomType: 'x' 
            },
            title: {
                text: 'Nouveaux cas de deces par jour'
            },
            xAxis: {
                categories: [  ";
...
$chaine.="  },yAxis: {
            ...
            series: [{
				name: 'Nouveaux cas de deces',
                data: [";
$resultat=$conn-> query ("SELECT deces from V_2");
//if (! $resultat) { echo "Erreur requete"; exit;} 
