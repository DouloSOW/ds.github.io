...
$chaine.="
        var myChart = Highcharts.chart('container8', {
            ...
            title: {
                text: 'Nouveaux cas de transmissions communautaires par jour'
            },
            xAxis: {
                categories: [  ";
...
$chaine.="  },yAxis: {
                title: {
                    text: 'Nombre de transmissions communautaires'
                }
            },
			plotOptions: {
				series: {
            ...
            series: [{
				name: 'Nouveaux cas de transmissions communautaires',
                data: [";
$resultat=$conn-> query ("SELECT trans_com from V_2");
//if (! $resultat) { echo "Erreur requete"; exit;} 
